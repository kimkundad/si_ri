                    ...
                    @endif
                      ...
                      {{ method_field($method) }}
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="first_text" value="{{ $objs->first_text }}" >
														</div>
												</div>
                        ...
                        <div class="form-group">
													...
													<div class="col-md-8">
														<input type="text" class="form-control" name="secend_text" value="{{ $objs->secend_text }}" >
														</div>
												</div>
                        ...
                        <div class="form-group">
								                        <label for="name" class="col-sm-3 control-label">ICON Image Upload</label>
								                        <div class="col-sm-8">
								                            <img src="{{url('assets/uploads/'.$objs->icon)}}" class="img-responsive" style="height:300px;" >
								                        </div>
								                    </div>
                                    ...
                                    <div class="form-group">
            								                        ...
            								                        <div class="col-sm-8">
            								                            <img src="{{url('assets/uploads/'.$objs->bg_image)}}" class="img-responsive" height="250">
            								                        </div>
            								                    </div>


                        <div class="form-group">
                          <label class="col-md-3 control-label">Icon Image Uploa</label>
                          <div class="col-md-9">
